      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-sand-900 mb-6">
            Explore o{' '}
            <span className="text-gradient-sunset">Caribe Brasileiro</span>
          </h2>
          <p className="text-lg text-sand-600 leading-relaxed">
            Roteiros exclusivos saindo do Vila Galé Touros. Descubra paisagens
            de tirar o fôlego e crie memórias inesquecíveis.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-coral-100 text-lg mb-8 max-w-xl mx-auto">
              Quer montar um roteiro exclusivo para seu grupo? Entre em contato
              e organizamos tudo para você.
            </p>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
