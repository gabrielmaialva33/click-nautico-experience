  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="h-full w-full drop-shadow-lg">
        ...
        {/* Face */}
        <ellipse cx="50" cy="52" rx="28" ry="30" fill="url(#skinGrad)" />
        ...
        <g>
          {/* Left eye */}
          <ellipse cx="38" cy="50" rx="6" ry={isBlinking ? 1 : 5} fill="white" />
          <motion.circle
            cx="38"
            cy="50"
            r={isBlinking ? 0 : 3}
          ...
          />
          <circle cx="36" cy="48" r="1" fill="white" opacity={isBlinking ? 0 : 1} />

          {/* Right eye */}
          <ellipse cx="62" cy="50" rx="6" ry={isBlinking ? 1 : 5} fill="white" />
          <motion.circle
            cx="62"
            cy="50"
            r={isBlinking ? 0 : 3}
            ...
            transition={{ duration: 2, repeat: isThinking ? Infinity : 0 }}
          />
          <circle cx="60" cy="48" r="1" fill="white" opacity={isBlinking ? 0 : 1} />
        </g>
